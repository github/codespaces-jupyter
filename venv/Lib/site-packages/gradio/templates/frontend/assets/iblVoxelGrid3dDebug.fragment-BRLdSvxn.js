import{S as r}from"./index-B3XdImUZ.js";import"./index-0BmjH1qd.js";const e="iblVoxelGrid3dDebugPixelShader",a=`varying vUV: vec2f;var voxelTextureSampler: sampler;var voxelTexture: texture_3d<f32>;var voxelSlabTextureSampler: sampler;var voxelSlabTexture: texture_2d<f32>;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform sizeParams: vec4f;
...
fragmentOutputs.color=vec4f(mix(background.rgb,voxelSlab.rgb,voxelSlab.a)+voxel,1.0);}}`;r.ShadersStoreWGSL[e]||(r.ShadersStoreWGSL[e]=a);const i={name:e,shader:a};export{i as iblVoxelGrid3dDebugPixelShaderWGSL};
