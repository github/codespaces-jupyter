import{S as e}from"./index-B3XdImUZ.js";import"./oitFragment-BFci_2Nh.js";import"./openpbrUboDeclaration-x7vCT2IB.js";import"./pbrDebug-D0Xn3woR.js";import"./shadowsFragmentFunctions-vLDpEnsj.js";import"./bumpFragment-Dcw23eyd.js";import"./imageProcessingFunctions-D1ynYTWl.js";import"./clipPlaneFragment-CAMQ29_J.js";import"./logDepthDeclaration-Bsi1tE5K.js";import"./fogFragment-Ch4cxWpp.js";import"./helperFunctions-Fr3o10XF.js";import"./hdrFilteringFunctions-Dzb-IYkw.js";import"./harmonicsFunctions-311zWTPz.js";import"./pbrBRDFFunctions-OvIUamwK.js";import"./index-0BmjH1qd.js";import"./sceneUboDeclaration-CqbEwU1P.js";import"./meshUboDeclaration-Dvh-7_US.js";import"./mainUVVaryingDeclaration-YIdsOrQ2.js";const i="openpbrFragmentDeclaration",h=`uniform vec4 vEyePosition;uniform float vBaseWeight;uniform vec4 vBaseColor;uniform float vBaseDiffuseRoughness;uniform vec4 vReflectanceInfo;uniform vec4 vSpecularColor;uniform vec3 vSpecularAnisotropy;uniform float vCoatWeight;uniform vec3 vCoatColor;uniform float vCoatRoughness;uniform float vCoatRoughnessAnisotropy;uniform float vCoatIor;uniform float vCoatDarkening;uniform float vFuzzWeight;uniform vec3 vFuzzColor;uniform float vFuzzRoughness;uniform vec2 vGeometryCoatTangent;uniform vec3 vEmissionColor;uniform float vThinFilmWeight;uniform vec2 vThinFilmThickness;uniform float vThinFilmIor;uniform vec4 vLightingIntensity;uniform float visibility;
#ifdef BASE_COLOR
...
#endif
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=G);const E="openpbrFuzzLayerData",z=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=z);const p="openpbrEnvironmentLighting",x=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=x);const I="openpbrDirectLightingInit",y=`#ifdef LIGHT{X}
...
`;e.ShadersStore[o]||(e.ShadersStore[o]=R);const ne={name:o,shader:R};export{ne as openpbrPixelShader};
