import{S as r}from"./index-B3XdImUZ.js";import"./helperFunctions-Ca8QW1H8.js";import"./index-0BmjH1qd.js";const e="iblIcdfPixelShader",t=`#include<helperFunctions>
varying vUV: vec2f;
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;r.ShadersStoreWGSL[e]||(r.ShadersStoreWGSL[e]=t);const u={name:e,shader:t};export{u as iblIcdfPixelShaderWGSL};
