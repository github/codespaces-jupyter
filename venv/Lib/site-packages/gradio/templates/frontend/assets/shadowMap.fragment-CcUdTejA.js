import{S as e}from"./index-B3XdImUZ.js";import"./packingFunctions-CWjNb-uA.js";import"./clipPlaneFragment-CM94cr2s.js";import"./index-0BmjH1qd.js";const r="bayerDitherFunctions",f=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=f);const t="shadowMapFragmentExtraDeclaration",S=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=S);const n="shadowMapFragment",s=`var depthSM: f32=fragmentInputs.vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=s);const a="shadowMapPixelShader",i=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=i);const M={name:a,shader:i};export{M as shadowMapPixelShaderWGSL};
