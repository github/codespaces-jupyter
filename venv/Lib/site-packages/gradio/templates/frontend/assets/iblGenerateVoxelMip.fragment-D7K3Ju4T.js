...
<< 7u;glFragColor.rgb=vec3(float(tex)/255.0f,0.0f,0.0f);glFragColor.a=1.0;}`;i.ShadersStore[e]||(i.ShadersStore[e]=r);const u={name:e,shader:r};export{u as iblGenerateVoxelMipPixelShader};
